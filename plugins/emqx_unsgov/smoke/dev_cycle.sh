...
PLUGIN="emqx_unsgov-1.0.0"
PLUGIN_TAR="$ROOT_DIR/plugins/emqx_unsgov/_build/default/emqx_plugrel/$PLUGIN.tar.gz"
PLUGIN_DIR="$ROOT_DIR/_build/emqx-enterprise/rel/emqx/plugins/$PLUGIN"
PLUGIN_DST_DIR="$ROOT_DIR/_build/emqx-enterprise/rel/emqx/plugins"
